...
class Vocabulary:
    ...
    def load(self, word2index_dic = 'word2index_dic', index2word_dic = 'index2word_dic',
        ...
        with open('/kaggle/input/save-dictionary/'+word2index_dic+'.p', 'rb') as fp:
            self.word2index = pickle5.load(fp)
            
        with open('/kaggle/input/save-dictionary/'+index2word_dic+'.p', 'rb') as fp:
            self.index2word = pickle5.load(fp)
            
        with open('/kaggle/input/save-dictionary/'+word2count_dic+'.p', 'rb') as fp:
