...
algorithm = "LVML" # soft, hard or LVML here
...
plt.ylabel(r"$\bf s^{LV}_y$",fontweight="bold",fontsize=20) # change xlabel based on algo
plt.xticks([1,2,3,4,5],weight="bold",fontsize=18)
plt.yticks([1,2,3,4,5],weight="bold", va="top",fontsize=18)

plt.savefig("train_ml_m_5_50k.pdf",bbox_inches='tight')
...
plt.savefig("test_ml_m_5_50k.pdf",bbox_inches='tight')
#plt.savefig("ML_Loss_M_5_10K.pdf",bbox_inches='tight')
